...
-- NOTA CRUCIAL: page_id aceita NULL para ganhos gerais (origem = 'geral')
...
-- Constraint única de page_id + data para evitar duplicidade no mesmo dia
...
-- ==============================================================================
-- ROW LEVEL SECURITY (RLS) - SEGURANÇA TOTAL POR USUÁRIO
-- Cada usuário visualiza, edita e exclui SOMENTE seus próprios registros
-- ==============================================================================
...
-- Políticas para follower_history
